...
// in boring_counter/test/unit_test/presentation/counter_list/cubit/counter_list_cubit_test.dart.
...
/// A class which mocks [WatchCountersUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockWatchCountersUseCase extends _i1.Mock
    implements _i2.WatchCountersUseCase {
  @override
  ...
  @override
  _i4.Stream<List<_i2.Counter>> watch() => (super.noSuchMethod(
        Invocation.method(
          #watch,
          [],
        ),
        returnValue: _i4.Stream<List<_i2.Counter>>.empty(),
        returnValueForMissingStub: _i4.Stream<List<_i2.Counter>>.empty(),
      ) as _i4.Stream<List<_i2.Counter>>);
}

/// A class which mocks [CreateCounterUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockCreateCounterUseCase extends _i1.Mock
    implements _i2.CreateCounterUseCase {
  @override
  _i2.CounterRepository get repository => (super.noSuchMethod(
        Invocation.getter(#repository),
        returnValue: _FakeCounterRepository_0(
  ...
  @override
  _i4.Future<_i2.Counter> create({required String? name}) =>
      (super.noSuchMethod(
        Invocation.method(
          #create,
          [],
